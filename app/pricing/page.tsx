  ...
  return (
    <div className="min-h-screen" style={{ background: "#fafafa" }}>
      ...
      <header className="relative overflow-hidden" style={{ background: "#0a0a0a" }}>
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[40rem] h-[24rem] rounded-full opacity-30 blur-[120px] pointer-events-none" style={{ background: "radial-gradient(circle, #0066ff, transparent 60%)" }} />
        <div className="absolute bottom-0 right-0 w-[24rem] h-[20rem] rounded-full opacity-20 blur-[120px] pointer-events-none" style={{ background: "radial-gradient(circle, #ec4899, transparent 60%)" }} />
        ...
        <div className="relative mx-auto max-w-3xl px-6 pt-6 pb-20 md:pt-12 md:pb-24 text-center md:px-10">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-white tracking-tight leading-[1.05]">
            Simple pricing for{" "}
            <span style={{ background: "linear-gradient(90deg, #60a5fa, #a855f7 50%, #f472b6)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>every stage</span>.
          </h1>
        ...
        <div className="grid gap-5 md:grid-cols-3">
          ...
          <article className="relative rounded-2xl p-8 flex flex-col shadow-[0_12px_48px_rgba(15,23,42,0.2)] hover-lift overflow-hidden" style={{ background: "#0a0a0a", border: "1px solid #222" }}>
            ...
            <div className="absolute top-0 left-0 right-0 py-2 text-center">
              <div className="inline-flex items-center justify-center gap-1 w-full py-1.5 text-[10px] font-bold tracking-[0.3em] text-white" style={{ background: "linear-gradient(90deg, #6366f1, #a855f7 50%, #ec4899)" }}>
