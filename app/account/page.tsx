    ...
    <div className="min-h-screen" style={{ background: "#0a0a0a" }}>
      ...
      <nav className="sticky top-0 z-40 backdrop-blur-xl" style={{ background: "rgba(10,10,10,0.75)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
        <div className="mx-auto max-w-6xl px-6 md:px-10 h-14 flex items-center justify-between">
          <Link href="/" className="inline-flex items-center gap-2 text-sm font-bold text-white">
            <span className="w-6 h-6 rounded-md flex items-center justify-center text-[10px] font-black" style={{ background: "linear-gradient(135deg, #0066ff, #ec4899)" }}>AI</span>
            AI Readiness
          </Link>
      ...
      <div className="mx-auto max-w-6xl px-6 pt-10 md:pt-14 pb-20 md:px-10">
        ...
        <section className="mt-10 rounded-2xl overflow-hidden" style={{ background: "#111111", border: "1px solid rgba(255,255,255,0.08)" }}>
          <div className="p-6 md:p-8 flex flex-col md:flex-row md:items-center gap-6">
            {user.imageUrl ? (
              ...
              <div className="w-20 h-20 rounded-full flex-shrink-0 ring-1 ring-white/10 flex items-center justify-center text-3xl font-black text-white" style={{ background: "linear-gradient(135deg, #0066ff, #a855f7)" }}>
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {plan === "pro" ? (
                  <span className="inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-bold tracking-wider text-white" style={{ background: "linear-gradient(90deg, #818cf8, #ec4899)" }}>
        ...
        <section className="mt-6 grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 rounded-2xl overflow-hidden" style={{ background: plan === "pro" ? "linear-gradient(140deg, rgba(0,102,255,0.1), rgba(168,85,247,0.05) 60%, rgba(236,72,153,0.1)), #111" : "#111", border: "1px solid rgba(255,255,255,0.08)" }}>
