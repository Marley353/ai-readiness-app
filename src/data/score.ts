...
export const STARTING_FACILITIES: [string, number, number][] = [['access-lift', 2, 2], ['living-quarters', 3, 2], ['general-stores', 2, 3], ['laboratory', 3, 3], ['workshop', 4, 3], ['small-radar', 1, 2], ['hangar', 0, 0], ['hangar', 2, 0]];
